...
func init() {
	register.RegisterTest(&register.Test{
		...
		ClusterSize:          0,
		Name:                 `fcos.ignition.boot-mirror.luks`,
...
func runBootMirrorLUKSTest(c cluster.TestCluster) {
	...
	if err = m.(platform.QEMUMachine).RemoveBlockDevice("/machine/peripheral-anon/device[5]", m, j); err != nil {
	...
	// }
	c.MustSSH(m, "mdadm --detail /machine/peripheral-anon/device[4]")
